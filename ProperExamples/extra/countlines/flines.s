/*
A program that count lines in a file. It will take the path of a file as input and will count
how many lines are there. The new line symbol (i.e.: '\n') will be used to detect new lines.
*/
