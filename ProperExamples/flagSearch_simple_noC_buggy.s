#flagSearch_simple_noC_buggy.s
#
#A simple program that given a value and some flags
#will return as exit code which flags it found.
#
#Assemble as: gcc -c flagSearch_simple_noC_buggy.s
#Link as: ld flagSearch_simple_noC_buggy.o -o flagSearch_simple_noC_buggy
#Run as: ./flagSearch_simple_noC_buggy ; echo $?
